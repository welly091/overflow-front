...
export default function Signup(props){
  ...
  return(
    ...
    className='flex flex-col w-3/5 p-3 pb-12 m-auto my-5 space-y-5 font-serif text-center border-2 border-black rounded-md shadow-lg mt-28 shadow-black'>
      ...
      <label className='flex flex-row mb-4 text-4xl font-bold'> Email
      ...
      <label className='flex flex-row mb-4 text-4xl font-bold'> Re-enter Password
