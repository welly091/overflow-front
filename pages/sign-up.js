...
export default function signUp(props){
  return(
    <>
    <form className='flex flex-col w-3/5 p-3 pb-12 m-auto my-5 space-y-5 font-serif text-center border-2 border-black rounded-md mt-28'>
      ...
      <button className='absolute flex flex-row justify-center w-20 h-8 bg-blue-300 border-blue-600 right-80 bottom-48 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-blue-400 duration-300 ... font-semibold'>Sign Up</button>
    </form>
    </>
  )
}