export default function Footer() {
  return (
    <>
      <footer className='bg-black mt-96 text-white p-4 font-mono font-semibold h-screen text-opacity-25'>
        <p className='mt-4 pt-10'>&copy; Stack Fellows 2022</p>
        <ul className='flex justify-center space-x-4 '>
          ...
          <li> 
            ...
            <a href='https://github.com/401d19-final'>
