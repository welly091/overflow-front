...
export default function Main(props) {
  ...
  return (
    ...
    <form>
      <label>
        <input id='search-bar' name='' className='flex-auto items-center w-full ml-96 mt-6 max-w-md mx-auto shadow rounded border-0 p-3 border-gray-800 mr-auto m-auto shadow-lg border-double border-4 border-black mt-16' type='text' placeholder='search..'/>
      </label>
   ...
   <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-black">
      ...
      {question_loading || !question_resources ? null :
        question_resources.map((question, idx) => (
          <div key={idx} className='mx-auto box-border w-1/2 p-4 border-4 mt-8'>
            <Link href={{
      ...
      {user ? <QuestionForm create={createQuestion} : null/>
